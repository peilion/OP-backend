...
async def read_the_latest_vibration_feature(
        ...
        features: List[str] = Query(
            ['urms', 'uthd', 'umax_current', 'umin_current', 'ufrequency', 'uamplitude',
             'uinitial_phase',
             'vrms', 'vthd', 'vmax_current', 'vmin_current', 'vfrequency', 'vamplitude',
             'vinitial_phase',
             'wrms', 'wthd', 'wmax_current', 'wmin_current', 'wfrequency', 'wamplitude',
             'winitial_phase',
...
async def read_vibration_feature_by_id(
        ...
        data_id: int,
        features: List[str] = Query(
            ['urms', 'uthd', 'umax_current', 'umin_current', 'ufrequency', 'uamplitude', 'uinitial_phase',
             'vrms', 'vthd', 'vmax_current', 'vmin_current', 'vfrequency', 'vamplitude', 'vinitial_phase',
             'wrms', 'wthd', 'wmax_current', 'wmin_current', 'wfrequency', 'wamplitude', 'winitial_phase',
             'n_rms', 'p_rms', 'z_rms', 'imbalance', 'health_indicator'],
            description='Only these fileds can be returned now.'),
        mp_mapper: dict = Depends(get_mp_mapper)
):
