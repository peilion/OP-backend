...
th1 = Threshold(mp_pattern='motor_driven',
                diag_threshold={'Unbalance': [1, 2, 3],
                                'Misalignment': [1, 2, 3],
                                'RollBearing': [1, 2, 3],
                                'ALoose': [1, 2, 3],
                                'BLoose': [1, 2, 3],
...
th2 = Threshold(mp_pattern='motor_non_driven',
                diag_threshold={'Unbalance': [1, 2, 3],
                                'RollBearing': [1, 2, 3],
                                'ALoose': [1, 2, 3],
                                'BLoose': [1, 2, 3],
...
th3 = Threshold(mp_pattern='pump_driven',
                diag_threshold={'Unbalance': [1, 2, 3],
                                'Misalignment': [1, 2, 3],
                                'RollBearing': [1, 2, 3],
                                'ALoose': [1, 2, 3],
...
th4 = Threshold(mp_pattern='pump_non_driven',
                diag_threshold={'Unbalance': [1, 2, 3],
                                'RollBearing': [1, 2, 3],
                                'Surge': [1, 2, 3],
                                'ALoose': [1, 2, 3],
