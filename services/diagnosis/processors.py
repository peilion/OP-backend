...
class MotorDriven(MeasurePoint, UnbalanceMixin, MisalignmentMixin, RollBearingMixin, ALooseMixin,
                  BLooseMixin, RubbingMixin):
...
class MotorNonDriven(MeasurePoint, UnbalanceMixin, RollBearingMixin, ALooseMixin, BLooseMixin):
    require_phase_diff = False
...
class PumpDriven(MeasurePoint, UnbalanceMixin, MisalignmentMixin, RollBearingMixin, ALooseMixin,
                 BLooseMixin, SurgeMixin, RubbingMixin):
    # Mixin的继承顺序必须与故障代码的顺序完全一致
    require_phase_diff = False
...
class PumpNonDriven(MeasurePoint, UnbalanceMixin, RollBearingMixin, ALooseMixin, BLooseMixin, SurgeMixin):
    require_phase_diff = False
