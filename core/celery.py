...
def cal_elec_feature():
    ...
    mps = (
        session.query(MeasurePoint.station_id, MeasurePoint.id_inner_station)
    ...
    for station_id in group_dict.keys():
        ...
        for mp_id in mp_ids:
            ...
            try:
                ...
                session.close()
                print(
                    "inserted rows/uncalculated rows: {}/{}".format(
                        len(to_save), len(data)
                    )
                )
        ...
        for mp_id in mp_ids:
            ...
            if len(data) > 0:
                ...
                for row in data:
                    ...
                    to_save.append(
                        feature(
                            rms=vib_feature_tools.rms_fea(signal),
