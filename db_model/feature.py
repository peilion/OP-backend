        ...
        if ModelClass is None:
            ModelClass = type(
                ...
                dict(
                    ...
                    est_rms=Column(Float, default=0),
                    est_max=Column(Float, default=0),
                    est_p2p=Column(Float, default=0),
                    est_avg=Column(Float, default=0),
                    est_var=Column(Float, default=0),
                    est_kurtosis=Column(Float, default=0),
